...
function LoginForm() {
  ...
  return (
    <div className="relative min-h-screen w-full bg-white overflow-hidden flex items-center justify-center">
      ...
      {/* Login card */}
      <div className="relative z-10 bg-white border border-[#d5dde2] rounded-xl p-6 w-full max-w-[421px] mx-4 flex flex-col gap-8 shadow-sm">
        {/* Header */}
